 ...
 */
public class BaseScrollSystemActivity extends AppCompatActivity {
    private static List<ViewPagerAdapter.ViewPagerBean> fragments = new ArrayList<>();

    public static void start(Context context) {
        context.startActivity(new Intent(context, BaseScrollSystemActivity.class));
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_base_scroll_system);
